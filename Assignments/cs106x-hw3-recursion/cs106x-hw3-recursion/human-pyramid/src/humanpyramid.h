/*
 * CS 106X Human Pyramid Recursion Problem
 * This file declares a necessary function prototype, so that other files
 * are able to call the recursive function you will write.
 * 
...
#ifndef _humanpyramid_h
#define _humanpyramid_h
