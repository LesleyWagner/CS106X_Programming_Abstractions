...
private:   
    // vector of pointers to lines sorted in reading order
    Vector<Line *> sortedLines;

    // Returns a string representation of the lines of text.
    friend ostream& operator <<(ostream& out, const LineManager& lines);
};
